...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		DashboardItem btnBadges = new DashboardItem(I18n.get("badges"), 3) {
			@Override
		...
		DashboardItem btnAbout = new DashboardItem(I18n.get("about"), 1) {
			@Override
			protected void onClick() {
		...
		DashboardItem btnPlay = new DashboardItem(I18n.get("play"), 0) {
			@Override
			protected void onClick() {
		...
		DashboardItem btnHighscores = new DashboardItem(I18n.get("highscores"), 2) {
			@Override
			protected void onClick() {
